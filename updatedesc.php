...
width:50%;
  ...
  <body>
<div id="add">
<form  method="post" action="updatedesc.php?action=update&id=<?php echo $_GET["pro_id"]; ?>" >
<div  class="form-group">
Give new Desccription: <input type="text" class="form-control "name="name">
</div>
<div  class="form-group">
<input name="update_descri" type="submit">
</div>
</form>

<?php
if(isset($_POST["update_descri"]))
{
